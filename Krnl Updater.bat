...
REM Set the below variable to 0, and then switch every instance of "USER" with your windows username to use this.
set switch=1
...
ping 127.0.0.1 -n 6 > nul
move "C:\Users\USER\Downloads\krnl_console_bootstrapper.exe" "C:\Users\USER\Desktop\KRNL"
